...
project.addExclude('Sources/Shaders/**');
project.addExclude('Sources/kinc/audio1/**');
project.addExclude('Sources/kinc/audio2/**');
project.addExclude('Sources/kinc/graphics1/**');
project.addExclude('Sources/kinc/graphics5/**');
project.addExclude('Sources/kinc/network/**');
project.addExclude('Sources/kinc/threads/**');
project.addExclude('Sources/kinc/vr/**');
project.addExclude('Sources/kinc/compute/**');
...
if (platform === Platform.Windows) {
	...
	project.addExclude('Backends/System/Windows/Libraries/DirectShow/**');
	project.addExclude('Backends/System/Windows/Sources/Kore/Video.*');
	project.addExclude('Backends/System/Windows/Sources/Kore/Video*.*');
	project.addExclude('Backends/System/Windows/Sources/Kore/Http.c');
	project.addExclude('Backends/System/Windows/Sources/Kore/Vr*.*');
